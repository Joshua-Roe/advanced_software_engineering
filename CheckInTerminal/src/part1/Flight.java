...
public class Flight implements Subject {
	...
	/**
	 * Constructs a <tt>Flight</tt> object with given parameters as its flight
	 * details.
	 * 
	 ...
	 * @param excessFee the levy charged for baggage that exceed the baggage
	 *                  limitations.
	 */
	...
	/**
	 * Checks baggage against baggage restrictions, and applies excess fee if limits
	 * are exceeded.
	 * 
	 * @param weight the weight of the baggage being checked in.
	 * @param volume the volume of the baggage being checked in.
	 * @throws OverBaggageLimitException if baggage weight or volume exceeds the
	 *                                   limitation.
	 */
