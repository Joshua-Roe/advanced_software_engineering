...
public class ManagementGUI extends Thread implements Observer, ChangeListener {
  class PassengerComponent extends JPanel {
    ...
    public PassengerComponent(Booking currentBooking) {
      ...
      this.setLayout(new GridLayout(0, 3)); // set layout
...
//      this.add(sizeText);
    //   this.setMaximumSize(new Dimension(2000,20));
      ...
      this.setToolTipText("<html>" + "Name: " + currentBooking.getFullName() +"<br>" + "Booking Reference: " + currentBooking.getReference() +"<br>" + "Baggage Length: " + currentBooking.getBaggageLength() + "<br>" + "Baggage Width: " + currentBooking.getBaggageWidth() + "<br>" + "Baggage Height: " + currentBooking.getBaggageHeight() + "</html>");
    }
  }
